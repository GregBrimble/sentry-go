...
func TestContextifyFrames(t *testing.T) {
	...
	frames := cfi.contextify([]Frame{{
		Function: "Trace",
		Module:   "github.com/GregBrimble/sentry-go",
		Filename: filename,
		AbsPath:  abspath,
		Lineno:   12,
		InApp:    true,
	...
	tests := []struct {
		...
		},
		{
			...
			info: &debug.BuildInfo{
				...
				Deps: []*debug.Module{
					{
						Path:    "github.com/GregBrimble/sentry-go",
						Version: "v0.5.1",
					},
					{
			...
			want: map[string]string{
				"my/module":                        "(devel)",
				"github.com/GregBrimble/sentry-go": "v0.5.1",
		...
		},
		{
			...
			want: map[string]string{
				"my/module":                        "(devel)",
				"github.com/GregBrimble/sentry-go": "v0.5.1 => pkg/sentry",
			},
		},
		{
