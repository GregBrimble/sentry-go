...
var tracetext = []byte(`
goroutine 7 [running]:
github.com/GregBrimble/sentry-go/internal/traceparser.TestGenerateTrace.func1()
	c:/dev/sentry-go/internal/traceparser/parser_test.go:23 +0x6c
created by github.com/GregBrimble/sentry-go/internal/traceparser.TestGenerateTrace in goroutine 6
...
github.com/GregBrimble/sentry-go.startProfiling.func3()
	c:/dev/sentry-go/profiler.go:46 +0x2b
github.com/GregBrimble/sentry-go.TestStart(0x0?)
...
github.com/GregBrimble/sentry-go.(*profileRecorder).Collect(0xc00008a820)
	c:/dev/sentry-go/profiler.go:73 +0x3b
github.com/GregBrimble/sentry-go.startProfiling.func2()
	c:/dev/sentry-go/profiler.go:38 +0xb1
created by github.com/GregBrimble/sentry-go.startProfiling
	c:/dev/sentry-go/profiler.go:31 +0x36c

goroutine 19 [chan send]:
github.com/GregBrimble/sentry-go.startProfiling.func1()
...
func TestParse(t *testing.T) {
	...
	checkTrace(7, `github.com/GregBrimble/sentry-go/internal/traceparser.TestGenerateTrace.func1()
	c:/dev/sentry-go/internal/traceparser/parser_test.go:23 +0x6c
created by github.com/GregBrimble/sentry-go/internal/traceparser.TestGenerateTrace in goroutine 6
	c:/dev/sentry-go/internal/traceparser/parser_test.go:17 +0x7f`)
...
main.main()
	...
	checkTrace(6, `github.com/GregBrimble/sentry-go.startProfiling.func3()
	c:/dev/sentry-go/profiler.go:46 +0x2b
github.com/GregBrimble/sentry-go.TestStart(0x0?)
	c:/dev/sentry-go/profiler_test.go:13 +0x3e
testing.tRunner(0xc00006f860, 0x6b5f98)
...
created by github.com/GregBrimble/sentry-go.startProfiling
	...
	checkTrace(19, `github.com/GregBrimble/sentry-go.startProfiling.func1()
	c:/dev/sentry-go/profiler.go:29 +0x25
...additional frames elided...
created by time.goFunc
	C:/Users/name/scoop/apps/go/current/src/time/sleep.go:176 +0x32`)
...
Trace 0: goroutine 7 with at most 2 frames
  Func = github.com/GregBrimble/sentry-go/internal/traceparser.TestGenerateTrace.func1
  File = c:/dev/sentry-go/internal/traceparser/parser_test.go
  Line = 23
  Func = github.com/GregBrimble/sentry-go/internal/traceparser.TestGenerateTrace
  File = c:/dev/sentry-go/internal/traceparser/parser_test.go
  Line = 17
...
Trace 2: goroutine 6 with at most 4 frames
  Func = github.com/GregBrimble/sentry-go.startProfiling.func3
  File = c:/dev/sentry-go/profiler.go
  Line = 46
  Func = github.com/GregBrimble/sentry-go.TestStart
...
Trace 3: goroutine 7 with at most 4 frames
  ...
  Line = 1193
  Func = github.com/GregBrimble/sentry-go.(*profileRecorder).Collect
  File = c:/dev/sentry-go/profiler.go
  Line = 73
  Func = github.com/GregBrimble/sentry-go.startProfiling.func2
  File = c:/dev/sentry-go/profiler.go
  Line = 38
  Func = github.com/GregBrimble/sentry-go.startProfiling
  File = c:/dev/sentry-go/profiler.go
  Line = 31
Trace 4: goroutine 19 with at most 2 frames
  Func = github.com/GregBrimble/sentry-go.startProfiling.func1
  File = c:/dev/sentry-go/profiler.go
  Line = 29
  Func = time.goFunc
