...
func TestSplitQualifiedFunctionName(t *testing.T) {
	tests := []struct {
		...
		{
			"github.com/GregBrimble/sentry-go.Init",
			"github.com/GregBrimble/sentry-go",
			"Init",
		},
		{
			"github.com/GregBrimble/sentry-go.(*Hub).Flush",
			"github.com/GregBrimble/sentry-go",
			"(*Hub).Flush",
		},
		{
			"github.com/GregBrimble/sentry-go.Test.func2.1.1",
			"github.com/GregBrimble/sentry-go",
			"Test.func2.1.1",
		},
		{
	...
	tests := []struct {
		...
		// considered outside of the SDK and thus included (useful for testing)
		{
			in: []runtime.Frame{
				...
				{
					Function: "github.com/GregBrimble/sentry-go_test.TestNewStacktrace.func1",
					File:     "/somewhere/sentry/sentry-go/stacktrace_external_test.go",
				},
				{
					Function: "github.com/GregBrimble/sentry-go.StacktraceTestHelper.NewStacktrace",
					File:     "/somewhere/sentry/sentry-go/stacktrace_test.go",
				},
				{
					Function: "github.com/GregBrimble/sentry-go.NewStacktrace",
			...
			out: []Frame{
				{
					...
					Module:   "github.com/GregBrimble/sentry-go_test",
		...
		// filter out integrations; SDK subpackages
		{
			in: []runtime.Frame{
				{
					Function: "github.com/GregBrimble/sentry-go/http/integration.Example.Integration",
					File:     "/somewhere/sentry/sentry-go/http/integration/integration.go",
				},
				{
					Function: "github.com/GregBrimble/sentry-go/http.(*Handler).Handle",
